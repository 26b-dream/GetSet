...
winget install MariaDB.Server --override "INSTALLDIR=C:\Programs\MariaDB ADDLOCAL=DBInstance,Client,MYSQLSERVER,SharedLibraries,DEVEL DATADIR=$env:USERPROFILE\MariaDB PASSWORD=1qaz1qaz UTF8=1 /quiet"
